# Ebay\Sell\ShippingFulfillmentApi
...
```php
createShippingFulfillment($order_id, $body): object
```
...
$apiInstance = new Ebay\Sell\Api\ShippingFulfillmentApi(
...
$body = new \Ebay\Sell\Fulfillment\Model\ShippingFulfillmentDetails(); // \Ebay\Sell\Fulfillment\Model\ShippingFulfillmentDetails | fulfillment payload
 ...
 **body** | [**\Ebay\Sell\Fulfillment\Model\ShippingFulfillmentDetails**](../Model/ShippingFulfillmentDetails.md)| fulfillment payload |
