...
class EbayFulfillmentProgram implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets fulfilled_by
     *
     * @param string|null $fulfilled_by The value returned in this field indicates the party that is handling fulfillment of the order line item. Valid value: EBAY
     *
     * @return self
     */
