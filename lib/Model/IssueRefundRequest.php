...
class IssueRefundRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets refund_items
     *
     * @param \Ebay\Sell\Fulfillment\Model\RefundItem[]|null $refund_items The refundItems array is only required if the seller is issuing a refund for one or more individual order line items in a multiple line item order. Otherwise, the seller just uses the orderLevelRefundAmount container to specify the amount of the refund for the entire order.
     *
     * @return self
     */
