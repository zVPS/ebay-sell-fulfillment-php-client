...
class ShippingFulfillmentApi
{
     ...
     * @param  \Ebay\Sell\Fulfillment\Model\ShippingFulfillmentDetails $body fulfillment payload (required)
     *
     ...
     */
    public function createShippingFulfillmentRequest($order_id, $body)
    {
